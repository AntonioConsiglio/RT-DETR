...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.run --nproc_per_node=4 tools/train.py -c configs/rtdetrv2/rtdetrv2_stdc2vd_6x_coco.yml --use-amp --seed=0 -u total_batch_size=64 --writer-type wandb &> log.txt 2>&1 &
